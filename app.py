...
if st.session_state.view == "LANDING":
    ...
    .block-container {
        z-index: 1;
        padding-top: 0rem; /* Remove default top padding for nav bar */
    }
    ...
    /* UI ELEMENTS */
    .nav-logo-text { font-size: 1.5rem; font-weight: 800; color: white; letter-spacing: 2px; }
    ...
    /* Adjust streamlit image margin in nav bar */
    [data-testid="stImage"] {
        margin-top: 10px;
    }
    ...
    # Added some padding at the top for the nav bar area
    ...
    with nav_c1: 
        ...
        if os.path.exists("logo.png"):
            ...
            st.markdown('<div class="nav-logo-text">TECTONICA</div>', unsafe_allow_html=True)
        # ---------------------------
