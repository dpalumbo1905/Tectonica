...
if st.session_state.view == "LANDING":
    ...
    .feature-card:hover .card-img { opacity: 1; }
    .card-content { padding: 20px; }
    .card-title {
        color: white; font-weight: bold; font-size: 1.1rem; margin-bottom: 5px;
    }
    .card-desc { color: #bbb; font-size: 0.9rem; }
    ...
    # D. FEATURE CARDS (NO INDENTATION TO PREVENT CODE BLOCK RENDERING)
    st.markdown("<br><br><br>", unsafe_allow_html=True)
    img_navis = "https://images.pexels.com/photos/834892/pexels-photo-834892.jpeg?auto=compress&cs=tinysrgb&w=600"
    img_super = "https://images.pexels.com/photos/544966/pexels-photo-544966.jpeg?auto=compress&cs=tinysrgb&w=600"
    img_procore = "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Procore_Logo.svg/512px-Procore_Logo.svg.png"
...
<div class="card-desc">Navisworks-grade clash detection in seconds.</div>
</div>
</div>
<div class="feature-card" style="flex: 1; min-width: 300px;">
...
<div class="card-desc">Reads blueprints like a Superintendent.</div>
</div>
</div>
<div class="feature-card" style="flex: 1; min-width: 300px;">
<div style="height:150px; background:white; display:flex; align-items:center; justify-content:center;">
<img src="{img_procore}" style="width:150px; height:auto;">
</div>
<div class="card-content">
<div class="card-title">🔗 PROCORE SYNC</div>
<div class="card-desc">Seamless integration with Construction OS.</div>
</div>
</div>
</div>
""", unsafe_allow_html=True)
